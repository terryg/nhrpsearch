...
public class NrhpPropertyDatabase implements PropertyDatabase {
	/**
	 * 
	 */
	...
	public SearchResult search(String input) {
		...
		NrhpPropertyList all = (NrhpPropertyList) _tree.get(key);
		...
		if (all != null) {
			...
			while (curr != null) {
				NrhpProperty property = curr.data;
    ...
    private void processProperty(XMLStreamReader parser) {
    	...
    	String entry;
     	...
     	for (String id : _ids) {
     		NrhpPropertyList properties = (NrhpPropertyList) _tree.get(id);
     		if (properties == null) {
     			properties = new NrhpPropertyList();
     		}
