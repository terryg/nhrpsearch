...
public class NrhpPropertyDatabase4 implements PropertyDatabase {
	/**
	 * 
	 */
	...
	private TernarySearchTree _tree = new TernarySearchTree();
	...
	public SearchResult search(String input) {
		...
		NrhpPropertyList all = _tree.get(key);
