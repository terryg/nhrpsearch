...
public class NrhpPropertyDatabase3 implements PropertyDatabase {
	/**
	 * 
	 */
	...
	private TreeMap<String, TreeSet<NrhpProperty>> _tree = new TreeMap<String, TreeSet<NrhpProperty>>();
	...
	public SearchResult search(String input) {
		...
		TreeSet<NrhpProperty> all = _tree.get(key);
    ...
    private void processProperty(XMLStreamReader parser) {
    	...
    	String entry;
     	...
     	for (String id : _ids) {
     		TreeSet<NrhpProperty> properties = _tree.get(id);
     		if (properties == null) {
     			properties = new TreeSet<NrhpProperty>();
