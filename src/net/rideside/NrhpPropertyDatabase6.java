...
public class NrhpPropertyDatabase6 implements PropertyDatabase {
	/**
	 * 
	 */
	...
	private BalancedTree _btree = new BalancedTree(5, 11);
	...
	public SearchResult search(String input) {
		...
		NrhpPropertyList all = _btree.get(key);
